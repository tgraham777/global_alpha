Rails.application.routes.draw do
  ...
  resources :visuals, only: [:show], param: :display_name
  resources :previews, only: [:index, :show], param: :title
  ...
  namespace :admin do
    ...
    resources :visuals, param: :display_name
    resources :previews, param: :title
