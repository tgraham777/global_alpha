...
$(document).ready(function(){
  ...
  $('#indicator-edit-add-visual-button').click(function(){
    $('.default-indicator-edit-items').append('<hr><label for="indicator_visuals_attributes_' + indicator_visual_count + '_title">Title</label><input class="form-control" type="text" value="" name="indicator[visuals_attributes][' + indicator_visual_count + '][title]" id="indicator_visuals_attributes_' + indicator_visual_count + '_title"><br><label for="indicator_visuals_attributes_' + indicator_visual_count + '_intro">Intro</label><textarea class="form-control" rows="8" name="indicator[visuals_attributes][' + indicator_visual_count + '][intro]" id="indicator_visuals_attributes_' + indicator_visual_count + '_intro"></textarea><br><label for="indicator_visuals_attributes_' + indicator_visual_count + '_link">Link</label><input class="form-control" type="text" value="" name="indicator[visuals_attributes][' + indicator_visual_count + '][link]" id="indicator_visuals_attributes_' + indicator_visual_count + '_link"><br><label for="indicator_visuals_attributes_' + indicator_visual_count + '_caption">Caption</label><input class="form-control" type="text" value="" name="indicator[visuals_attributes][' + indicator_visual_count + '][caption]" id="indicator_visuals_attributes_' + indicator_visual_count + '_caption"><br><label for="indicator_visuals_attributes_' + indicator_visual_count + '_description">Description</label><textarea class="form-control" rows="8" name="indicator[visuals_attributes][' + indicator_visual_count + '][description]" id="indicator_visuals_attributes_' + indicator_visual_count + '_description"></textarea><br>');
    indicator_visual_count++;
  });

  $('#preview-add-visual-button').click(function(){
    visual_number = count + 1;
    $('.default-preview-items').append('<h4>Visual #' + visual_number + '</h4><label for="preview_visuals_attributes_' + count + '_title">Title</label><input class="form-control" placeholder="Enter title" type="text" name="preview[visuals_attributes][' + count + '][title]" id="preview_visuals_attributes_' + count + '_title"><br><label for="preview_visuals_attributes_' + count + '_intro">Intro</label><textarea class="form-control" rows="8" placeholder="Enter introduction or explanation of visual" name="preview[visuals_attributes][' + count + '][intro]" id="preview_visuals_attributes_' + count + '_intro"></textarea><br><label for="preview_visuals_attributes_' + count + '_link">Link</label><input class="form-control" placeholder="Enter Tableau script or URL" type="text" name="preview[visuals_attributes][' + count + '][link]" id="preview_visuals_attributes_' + count + '_link"><br><label for="preview_visuals_attributes_' + count + '_caption">Caption</label><input class="form-control" placeholder="Enter caption for visual" type="text" name="preview[visuals_attributes][' + count + '][caption]" id="preview_visuals_attributes_' + count + '_caption"><br><label for="preview_visuals_attributes_' + count + '_description">Description</label><textarea class="form-control" rows="8" placeholder="Enter description for visual and/or additional text" name="preview[visuals_attributes][' + count + '][description]" id="preview_visuals_attributes_' + count + '_description"></textarea><br><hr>');
    count++;
  });

  var preview_visual_count = $('.preview-edit-page-visual-counter').length;

  $('#preview-edit-add-visual-button').click(function(){
    $('.default-preview-edit-items').append('<hr><label for="preview_visuals_attributes_' + preview_visual_count + '_title">Title</label><input class="form-control" type="text" value="" name="preview[visuals_attributes][' + preview_visual_count + '][title]" id="preview_visuals_attributes_' + preview_visual_count + '_title"><br><label for="preview_visuals_attributes_' + preview_visual_count + '_intro">Intro</label><textarea class="form-control" rows="8" name="preview[visuals_attributes][' + preview_visual_count + '][intro]" id="preview_visuals_attributes_' + preview_visual_count + '_intro"></textarea><br><label for="preview_visuals_attributes_' + preview_visual_count + '_link">Link</label><input class="form-control" type="text" value="" name="preview[visuals_attributes][' + preview_visual_count + '][link]" id="preview_visuals_attributes_' + preview_visual_count + '_link"><br><label for="preview_visuals_attributes_' + preview_visual_count + '_caption">Caption</label><input class="form-control" type="text" value="" name="preview[visuals_attributes][' + preview_visual_count + '][caption]" id="preview_visuals_attributes_' + preview_visual_count + '_caption"><br><label for="preview_visuals_attributes_' + preview_visual_count + '_description">Description</label><textarea class="form-control" rows="8" name="preview[visuals_attributes][' + preview_visual_count + '][description]" id="preview_visuals_attributes_' + preview_visual_count + '_description"></textarea><br>');
    preview_visual_count++;
  });
});
